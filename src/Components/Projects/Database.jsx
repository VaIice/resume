function Database() {
 return (
   <div className='project-section'>
       ...
       TMDB API를 활용하여 Python으로 영화, TV 프로그램, 인물 정보를 수집하고, <span className="highlight">Python</span>과 <span className="highlight">MySQL</span>로 데이터를 가공하여 통합 DB 시스템을 완성했습니다.
      ...
      <h5>주요 기능<span className="highlight">.</span></h5><span>플랫폼 정보 확인, 콘텐츠 검색, 상세 정보 제공</span>
